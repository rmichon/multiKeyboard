...
with{
	...
	gain = out_group(vslider("[2] Level [unit:dB] [style:knob] [tooltip: Output scale 
		factor]", -3, -70, 40, 0.1)) : ba.db2linear : si.smoo;
};

w = hslider("v:synth/v:standardParams/y",1,0,1,0.001)*2000;

process = ef.cubicnl(0.7,0)*0.5,ef.cubicnl(0.7,0)*0.5 : ve.wah4(w), ve.wah4(w) : myZita;
